...
extension Project {
    ...
    public static func framework(name: String, destinations: Destinations, additionalTargets: [String]) -> Project {
    ...
    public static func app(name: String, destinations: Destinations, additionalTargets: [String]) -> Project {
        var targets = makeAppTargets(
            name: name,
            destinations: destinations,
            dependencies: additionalTargets.map { name in
    ...
    private static func makeFrameworkTargets(name: String, destinations: Destinations) -> [Target] {
        let sources = Target(name: name,
                ...
                sources: ["Sources/**"],
                resources: [],
                dependencies: [.external(name: "Dependencies", condition: nil)])
